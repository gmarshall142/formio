...
var CustomComponentSv = function (_BaseComponent) {
  _inherits(CustomComponentSv, _BaseComponent);

  function CustomComponentSv() {
    _classCallCheck(this, CustomComponentSv);

    return _possibleConstructorReturn(this, (CustomComponentSv.__proto__ || Object.getPrototypeOf(CustomComponentSv)).apply(this, arguments));
  }

  _createClass(CustomComponentSv, [{
    key: 'elementInfo',
    value: function elementInfo() {
      var info = _get(CustomComponentSv.prototype.__proto__ || Object.getPrototypeOf(CustomComponentSv.prototype), 'elementInfo', this).call(this);
      info.type = 'button';
    ...
    value: function createInput(container) {
      this.buttonElement = _get(CustomComponentSv.prototype.__proto__ || Object.getPrototypeOf(CustomComponentSv.prototype), 'createInput', this).call(this, container);
    ...
    value: function destroy() {
      _get(CustomComponentSv.prototype.__proto__ || Object.getPrototypeOf(CustomComponentSv.prototype), 'destroy', this).apply(this, Array.prototype.slice.apply(arguments));
    ...
    key: 'defaultSchema',
    get: function get() {
      return CustomComponentSv.schema();
    }
  }, {
    key: 'loading',
    ...
    set: function set(disabled) {
      _set(CustomComponentSv.prototype.__proto__ || Object.getPrototypeOf(CustomComponentSv.prototype), 'disabled', disabled, this);
    ...
    set: function set(value) {
      ...
      _set(CustomComponentSv.prototype.__proto__ || Object.getPrototypeOf(CustomComponentSv.prototype), 'dataValue', value, this);
    }
  }, {
    key: 'className',
    get: function get() {
      var className = _get(CustomComponentSv.prototype.__proto__ || Object.getPrototypeOf(CustomComponentSv.prototype), 'className', this);
    ...
    get: function get() {
      return {
        title: 'CustomComponentSv',
        group: 'basic',
        icon: 'fa fa-stop',
        documentation: 'http://help.form.io/userguide/#button',
        weight: 110,
        schema: CustomComponentSv.schema()
      };
    }
  }]);

  return CustomComponentSv;
}(_Base2.default);
